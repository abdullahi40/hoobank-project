...
const FeedbackCard = ({ content, name, title, img}) => (
    ...
    rounded-[20px] max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card'>
      ...
      <p className="font-poppin font-normal text-[18px] 
      leading-[32px] text-white my-10">{content}</p>

      <div className="flex flex-row">
         <img src={img} alt={name} className="w-[48px] h-[40px] rounded-full" />
        
         <div className="flex flex-col ml-4">
          <h4  className="font-poppin font-semibold text-[20px] 
