    ...
    <section id="features" className={layout.section}>
      <div className={layout.sectionInfo}>
       <h2 className={styles.heading2}>
        ...
        <p className={`${styles.paragraph} max-w-[470px]mt-5`}>With the right credit card, you can improve your finecial
          life by building credit, earning reards and saving money. 
          But with hundreds of creadit cards on the market.
        </p>
        <Button styles="mt-10"/>
      </div>
